...
<section>
    <h1 style="text-align: center; margin-bottom: 1rem; color: var(--primary-color);">Responsible Gaming</h1>
    ...
    <div class="card">
        ...
        <h3 style="color: var(--primary-color); margin-top: 2rem; margin-bottom: 1rem;">Our Commitment to Responsible Entertainment</h3>
        ...
        <h3 style="color: var(--primary-color); margin-top: 2rem; margin-bottom: 1rem;">Understanding Our Platform</h3>
        ...
        <h3 style="color: var(--primary-color); margin-top: 2rem; margin-bottom: 1rem;">Tips for Responsible Entertainment</h3>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
            <div style="background: rgba(255, 255, 255, 0.05); padding: 1.5rem; border-radius: 10px; border: 1px solid rgba(255, 215, 0, 0.2);">
                <h4 style="color: var(--primary-color); margin-bottom: 1rem;">⏰ Set Time Limits</h4>
            ...
            <div style="background: rgba(255, 255, 255, 0.05); padding: 1.5rem; border-radius: 10px; border: 1px solid rgba(255, 215, 0, 0.2);">
                <h4 style="color: var(--primary-color); margin-bottom: 1rem;">🎯 Play for Fun</h4>
                <p style="color: var(--text-secondary);">
            ...
            <div style="background: rgba(255, 255, 255, 0.05); padding: 1.5rem; border-radius: 10px; border: 1px solid rgba(255, 215, 0, 0.2);">
                <h4 style="color: var(--primary-color); margin-bottom: 1rem;">💰 Budget Awareness</h4>
                <p style="color: var(--text-secondary);">
            ...
            <div style="background: rgba(255, 255, 255, 0.05); padding: 1.5rem; border-radius: 10px; border: 1px solid rgba(255, 215, 0, 0.2);">
                <h4 style="color: var(--primary-color); margin-bottom: 1rem;">👥 Maintain Balance</h4>
                <p style="color: var(--text-secondary);">
            ...
            <div style="background: rgba(255, 255, 255, 0.05); padding: 1.5rem; border-radius: 10px; border: 1px solid rgba(255, 215, 0, 0.2);">
                <h4 style="color: var(--primary-color); margin-bottom: 1rem;">🚫 Avoid Chasing Losses</h4>
                <p style="color: var(--text-secondary);">
            ...
            <div style="background: rgba(255, 255, 255, 0.05); padding: 1.5rem; border-radius: 10px; border: 1px solid rgba(255, 215, 0, 0.2);">
                <h4 style="color: var(--primary-color); margin-bottom: 1rem;">🧠 Self-Awareness</h4>
                <p style="color: var(--text-secondary);">
            ...
            <div style="background: rgba(255, 255, 255, 0.05); padding: 1.5rem; border-radius: 10px; border: 1px solid rgba(255, 215, 0, 0.2);">
                <h4 style="color: var(--primary-color); margin-bottom: 1rem;">👨‍👩‍👧‍👦 Protect Children</h4>
                <p style="color: var(--text-secondary);">
            ...
            <div style="background: rgba(255, 255, 255, 0.05); padding: 1.5rem; border-radius: 10px; border: 1px solid rgba(255, 215, 0, 0.2);">
                <h4 style="color: var(--primary-color); margin-bottom: 1rem;">📞 Seek Support</h4>
                <p style="color: var(--text-secondary);">
        ...
        <h3 style="color: var(--primary-color); margin-top: 2rem; margin-bottom: 1rem;">Warning Signs</h3>
        ...
        <h3 style="color: var(--primary-color); margin-top: 2rem; margin-bottom: 1rem;">Support Resources</h3>
        <p style="color: var(--text-secondary); line-height: 1.8; margin-bottom: 1rem;">
        ...
        <h3 style="color: var(--primary-color); margin-top: 2rem; margin-bottom: 1rem;">Our Commitment</h3>
        <p style="color: var(--text-secondary); line-height: 1.8;">
            We are committed to:
        </p>
        <ul style="color: var(--text-secondary); margin-left: 2rem; line-height: 1.8;">
        ...
        <h3 style="color: var(--primary-color); margin-top: 2rem; margin-bottom: 1rem;">Contact Us</h3>
        <p style="color: var(--text-secondary); line-height: 1.8;">
